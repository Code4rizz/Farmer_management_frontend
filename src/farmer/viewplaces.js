...
function ViewApplications() {
    ...
    const fetchApplications = async () => {
        try {
            ...
            const res = await api.get(`/farmer/my_applications_forall/${farmeremail}`);
                            ...
                            <Card.Body>
                              <div className="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                    <span className="text-muted fw-bold">Farmer Name:</span>
                                    <span className="text-muted fw-bold">{app.name}</span>
    
                            
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                    <span className="text-muted fw-bold">Certifier Name:</span>
                                     <span className="text-muted fw-bold">{app.Certification.cname}</span>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                    <span className="text-muted fw-bold">Inspector Name:</span>
                                     <span className="text-muted fw-bold">{app.Inspection.iname}</span>
                                    </div>
                                </div>
                                 <div className="mb-3">
